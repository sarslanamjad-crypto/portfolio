...
<head>
    ...
    <link href="{{ url('backend/css/admin-override.css') }}" rel="stylesheet">
    ...
    <ul class="navbar-nav bg-gradient-black sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/admin')}}">
                <div class="sidebar-brand-icon ">
                    <h5 class="m-0 text-white">{{ config('app.name', 'Admin') }}</h5>
                </div>
            </a>
            <br>
            ...
            <li class="nav-item {{ Request::is('admin/services', 'admin/service-add') ? 'active':''}}">
            ...
            <li class="nav-item {{ Request::is('admin/skills', 'admin/skill-add') ? 'active':''}}">
                ...
                <div id="collapseSkills" class="collapse" aria-labelledby="skills" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/admin/skills')}}">Skills</a>
                        <a class="collapse-item" href="{{url('/admin/skill-add')}}">Add Skill</a>
                    </div>
                </div>
            </li>
            <li class="nav-item {{ Request::is('admin/partners', 'admin/partner-add') ? 'active':''}}">
                ...
                <div id="collapsePartners" class="collapse" aria-labelledby="partners" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/admin/partners')}}">Partners</a>
                        <a class="collapse-item" href="{{url('/admin/partner-add')}}">Add Partner</a>
                    </div>
                </div>
            </li>
